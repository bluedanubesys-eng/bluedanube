...
export default function Page() {
  ...
  useEffect(() => {
    erpGet("documents", { shopId: CONFIG.defaultShopId }).then((res) => {
    ...
    <AdminLayout>
      <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-slate-500">Invoices, receipts, delivery slips and generated records.</p>
        </div>
      ...
      {loading ? (
        ...
        <DataTable title="Documents" rows={rows} />
      )}
    </AdminLayout>
  );
}
