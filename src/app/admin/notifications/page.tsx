...
export default function Page() {
  ...
  useEffect(() => {
    erpGet("notifications", { shopId: CONFIG.defaultShopId }).then((res) => {
    ...
    <AdminLayout>
      <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-slate-500">System alerts, order updates and business notifications.</p>
        </div>
      ...
      {loading ? (
        ...
        <DataTable title="Notifications" rows={rows} />
      )}
    </AdminLayout>
  );
}
