...
export default function Page() {
  ...
  useEffect(() => {
    erpGet("coupons", { shopId: CONFIG.defaultShopId }).then((res) => {
    ...
    <AdminLayout>
      <div className="mb-8 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 text-slate-500">Discount codes, campaigns and promotion records.</p>
        </div>
      ...
      {loading ? (
        ...
        <DataTable title="Coupons" rows={rows} />
      )}
    </AdminLayout>
  );
}
